...
# ---------------------------------------------/cut\-----------------------------------------------
#
# Include versions of Python you've tested with, whether it's 32 or 64 bit
# and which Operating
# System was hosting.
# e.g.:
# * Python 2.7.13-32 on Windows 7
...
# ---------------------------------------------/cut\-----------------------------------------------
#
# Template based on recommendations from Matt Harrison in Beginning Python
# Programming
#
# Progressively updated - keep version # below and "template version used"
# above in sync
...
# ---------------------------------------------/cut\-----------------------------------------------
# Enforce things required in v3.x:
# * See:  https://docs.python.org/2/library/__future__.html
